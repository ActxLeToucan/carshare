<template>
    <div class="flex h-fit w-full justify-between md:space-x-8 items-center my-2">
        ...
        <div>
            <div class="md:flex hidden h-fit rounded-md font-bold text-lg whitespace-nowrap text-ellipsis hover:border-slate-300 transition-all focus:outline outline-transparent">
                <button
                    ...
                    class="flex h-fit border-b-4 rounded-md px-4 py-2 font-bold text-lg whitespace-nowrap text-ellipsis transition-all mx-2 cursor-pointer">
