    ...
    <div>
        <router-link v-if="href"
            ...
            class="flex items-center justify-center w-fit h-fit py-2 px-4 text-slate-500 text-xl font-bold bg-white rounded-md bg-slate-100 border-b-4 border-slate-200
                outline-none hover:text-slate-50 hover:shadow-md transition-all"
        ...
        <span class="hidden hover:bg-teal-500 hover:bg-red-500 hover:bg-orange-500 hover:bg-blue-500 hover:bg-slate-500 hover:border-teal-600 hover:border-red-600 hover:border-orange-600 hover:border-blue-600 hover:border-slate-600 focus:border-teal-500 focus:border-red-500 focus:border-orange-500 focus:border-blue-500 focus:border-slate-500"></span>
    </div>
</template>
